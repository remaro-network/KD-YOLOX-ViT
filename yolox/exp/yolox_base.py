...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.enable_mixup = True#False#True
        ...
        self.test_size = (640, 640) #(416,416)
    ...
    def preprocess(self, inputs, targets, tsize, name_image):
        ...
        return inputs, targets, name_image
